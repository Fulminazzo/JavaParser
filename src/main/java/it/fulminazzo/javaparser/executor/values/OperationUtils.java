...
public final class OperationUtils {
    ...
    public static @NotNull Value<?> executeBinaryOperationDecimal(final @NotNull Value<?> left,
        ...
        else if (first instanceof Float) obj = floatOperation.apply(first.floatValue(), second.floatValue());
        else if (first instanceof Long) obj = longOperation.apply(first.longValue(), second.longValue());
