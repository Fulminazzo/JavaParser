...
class NumberValueTest extends Specification {
    ...
    def 'test #first < #second = #third'() {
        ...
        first                  | second                           | third
        // Integer
        new IntegerValue(100)  | new CharacterValue('a' as char)  | BooleanValue.FALSE
        new IntegerValue(100)  | new CharacterValue('z' as char)  | BooleanValue.TRUE
        new IntegerValue(100)  | new CharacterValue('d' as char)  | BooleanValue.FALSE
        new IntegerValue(100)  | new IntegerValue(2)              | BooleanValue.FALSE
        new IntegerValue(100)  | new IntegerValue(200)            | BooleanValue.TRUE
        new IntegerValue(100)  | new IntegerValue(100)            | BooleanValue.FALSE
        new IntegerValue(100)  | new LongValue(2L)                | BooleanValue.FALSE
        new IntegerValue(100)  | new LongValue(200L)              | BooleanValue.TRUE
        new IntegerValue(100)  | new LongValue(100L)              | BooleanValue.FALSE
        new IntegerValue(100)  | new FloatValue(2.0f)             | BooleanValue.FALSE
        new IntegerValue(100)  | new FloatValue(200.0f)           | BooleanValue.TRUE
        new IntegerValue(100)  | new FloatValue(100.0f)           | BooleanValue.FALSE
        new IntegerValue(100)  | new DoubleValue(2.0d)            | BooleanValue.FALSE
        new IntegerValue(100)  | new DoubleValue(200.0d)          | BooleanValue.TRUE
        ...
        new LongValue(100L)    | new IntegerValue(2)              | BooleanValue.FALSE
        new LongValue(100L)    | new IntegerValue(200)            | BooleanValue.TRUE
        ...
        new FloatValue(100.0f) | new IntegerValue(2)              | BooleanValue.FALSE
        new FloatValue(100.0f) | new IntegerValue(200)            | BooleanValue.TRUE
        ...
        new DoubleValue(100.0d) | new IntegerValue(2)             | BooleanValue.FALSE
        new DoubleValue(100.0d) | new IntegerValue(200)           | BooleanValue.TRUE
    ...
    def 'test #first <= #second = #third'() {
        ...
        new IntegerValue(100)  | new IntegerValue(2)              | BooleanValue.FALSE
        new IntegerValue(100)  | new IntegerValue(200)            | BooleanValue.TRUE
        new IntegerValue(100)  | new IntegerValue(100)            | BooleanValue.TRUE
        new IntegerValue(100)  | new LongValue(2L)                | BooleanValue.FALSE
        new IntegerValue(100)  | new LongValue(200L)              | BooleanValue.TRUE
        new IntegerValue(100)  | new LongValue(100L)              | BooleanValue.TRUE
        new IntegerValue(100)  | new FloatValue(2.0f)             | BooleanValue.FALSE
        new IntegerValue(100)  | new FloatValue(200.0f)           | BooleanValue.TRUE
        new IntegerValue(100)  | new FloatValue(100.0f)           | BooleanValue.TRUE
        new IntegerValue(100)  | new DoubleValue(2.0d)            | BooleanValue.FALSE
        new IntegerValue(100)  | new DoubleValue(200.0d)          | BooleanValue.TRUE
        ...
        new LongValue(100L)    | new IntegerValue(2)              | BooleanValue.FALSE
        new LongValue(100L)    | new IntegerValue(200)            | BooleanValue.TRUE
        new LongValue(100L)    | new IntegerValue(100)            | BooleanValue.TRUE
        new LongValue(100L)    | new LongValue(2L)                | BooleanValue.FALSE
        new LongValue(100L)    | new LongValue(200L)              | BooleanValue.TRUE
        ...
        new FloatValue(100.0f) | new IntegerValue(2)              | BooleanValue.FALSE
        new FloatValue(100.0f) | new IntegerValue(200)            | BooleanValue.TRUE
        new FloatValue(100.0f) | new IntegerValue(100)            | BooleanValue.TRUE
        new FloatValue(100.0f) | new LongValue(2L)                | BooleanValue.FALSE
        new FloatValue(100.0f) | new LongValue(200L)              | BooleanValue.TRUE
        ...
        new DoubleValue(100.0d) | new IntegerValue(2)             | BooleanValue.FALSE
        new DoubleValue(100.0d) | new IntegerValue(200)           | BooleanValue.TRUE
        new DoubleValue(100.0d) | new IntegerValue(100)           | BooleanValue.TRUE
        new DoubleValue(100.0d) | new LongValue(2L)               | BooleanValue.FALSE
        new DoubleValue(100.0d) | new LongValue(200L)             | BooleanValue.TRUE
