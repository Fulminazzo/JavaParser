...
class VisitorTest extends Specification {
    ...
    class MockVisitor implements Visitor<String> {
        ...
        @Override
        @NotNull
        Optional<String> visitProgram(@NotNull JavaProgram program) {
            return null
        }
        ...
        @Override
        @NotNull
        String visitBreak(@NotNull Node expression) {
            return null
        }

        @Override
        @NotNull
        String visitContinue(@NotNull Node expression) {
            return null
        }
        ...
        @Override
        @NotNull
        String visitSwitchStatement(@NotNull List<CaseStatement> cases, @NotNull CodeBlock defaultBlock, @NotNull Node expression) {
            return null
        }

        @Override
        @NotNull
        String visitCaseStatement(@NotNull CodeBlock block, @NotNull Node expression) {
            return null
        }

        @Override
        @NotNull
        String visitDoStatement(@NotNull CodeBlock code, @NotNull Node expression) {
            return null
        }

        @Override
        @NotNull
        String visitEnhancedForStatement(@NotNull Node type, @NotNull Node variable, @NotNull CodeBlock code, @NotNull Node expression) {
            return null
        }

        @Override
        @NotNull
        String visitForStatement(@NotNull Node assignment, @NotNull Node increment, @NotNull CodeBlock code, @NotNull Node expression) {
            return null
        }

        @Override
        @NotNull
        String visitIfStatement(@NotNull CodeBlock then, @NotNull Node elseBranch, @NotNull Node expression) {
            return null
        }

        @Override
        @NotNull
        String visitReturn(@NotNull Node expression) {
            return null
        }
        ...
        @Override
        @NotNull
        String visitStatement(@NotNull Node expression) {
            return null
        }

        @Override
        @NotNull
        String visitWhileStatement(@NotNull CodeBlock code, @NotNull Node expression) {
            return null
        }
